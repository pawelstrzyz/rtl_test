...
define('HEADING_TITLE', 'Drukowanie książki nadawczej');
...
define('TEXT_FROM','Od:');
define('TEXT_TO','Do: ');
define('TEXT_PRINTING_LABELS_BILLING_DELIVERY','W książce nadawczej ma zostać wydrukowany adres płatnika czy adres dostawy ?');
...
define('TEXT_INCLUDE_ORDERS_STATUS', 'Drukuj książkę nadawczą tylko do zamówień z określonym statusem:<br>(<i>jeżeli nie wybrano żadnej opcji zostaną wybrane wszystkie zamówienia</i>)');
define('TEXT_INCLUDE_SHIPPING_METHOD', 'Drukuj książkę nadawczą tylko do zamówień z określonym sposobem wysyłki:<br>(<i>jeżeli nie wybrano żadnej opcji zostaną wybrane wszystkie zamówienia</i>)');
...
define('BOOK_PRINT_INC', DIR_WS_MODULES . 'ksiazka_nadawcza/');
define('BATCH_PDF_DIR', 'pdf/temp_pdf/');
// Main File
define('BOOK_PRINT_FILE', 'ksiazka_nadawcza.php');
?>