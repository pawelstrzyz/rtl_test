...
require_once('pdf/fpdf/ufpdf.php');
...
class PDF_Label extends UFPDF {
	...
	var $_Avery_Labels = array (
		'0001'=>array('name'=>'0001',	'paper-size'=>'A4',	'metric'=>'mm',	'marginLeft'=>5,	'marginTop'=>13,		'NX'=>3,	'NY'=>8,	'SpaceX'=>0,	'SpaceY'=>0,	'width'=>66.000,	'height'=>34.000,		'font-size'=>11),
		...
		'L7163'=>array('name'=>'L7163',	'paper-size'=>'A4',		'metric'=>'mm',	'marginLeft'=>5,		'marginTop'=>15, 		'NX'=>2,	'NY'=>7,	'SpaceX'=>25,		'SpaceY'=>0,	'width'=>99.1,		'height'=>38.1,		'font-size'=>12)
	);
	...
	function Set_Font_Name($fontname) {
		if ($fontname != '') {
			...
			$this->AddFont($this->_Font_Name, '', 'arial.php');
