...
//  WIN-OR-ISO      - plik nie zawiera znaków specyficznych ¿adnego kodu, ale zawiera znaki wspólne
//  UTF-8           - kodowanie utf-8
//  UTF-16          - kodowanie utf-16


// Biblioteka mb, a w szczególnoœci funkcja mb_detect_encoding() nie
// umo¿liwiaj¹ wykrycia innego kodowania ni¿ ISO-8859-2 lub UTF-8 (w stosunku do polskich znaków).
// Wywo³anie:
//     echo mb_detect_encoding($org, 'ISO-8859-2, WINDOWS-1250, UTF-8');
// nie da po¿¹danych efektów, gdy¿ kodowanie WINDOWS-1250 nie jest rozpoznawane.
//
// Ponadto funkcja iconv() w przypadku napotkania niedozwolonych znaków koñczy przetwarzanie.
// St¹d potrzeba przygotowania w³asnej funkcji pl_detect().
//
//
// (c)2005 gajdaw
//  http://www.gajdaw.pl
...
//define('PL_ISO_ALL', '±æê³ñó¶¼¿¡ÆÊ£ÑÓ¦¬¯');  //linijka zakodowana jako iso
...
//define('PL_ISO_ALL_UPPER', '¡ÆÊ£ÑÓ¦¬¯');  //linijka zakodowana jako iso
...
//define('PL_ISO_ALL_LOWER', '±æê³ñó¶¼¿');  //linijka zakodowana jako iso
...
//define('PL_ISO_SPECIFIC', '±¶¼¡¦¬');  //linijka zakodowana jako iso
...
//define('PL_ISO_SPECIFIC_UPPER', '¡¦¬');  //linijka zakodowana jako iso
...
//define('PL_ISO_SPECIFIC_LOWER', '±¶¼');  //linijka zakodowana jako iso
...
//define('PL_WIN_ALL', '¹æê³ñóœŸ¿¥ÆÊ£ÑÓŒ¯');  //linijka zakodowana jako win
...
//define('PL_WIN_ALL_UPPER', '¥ÆÊ£ÑÓŒ¯');  //linijka zakodowana jako win
...
//define('PL_WIN_ALL_LOWER', '¹æê³ñóœŸ¿');  //linijka zakodowana jako win
...
//define('PL_WIN_SPECIFIC', '¹œŸ¥Œ');  //linijka zakodowana jako win
...
//define('PL_WIN_SPECIFIC_UPPER', '¥Œ');  //linijka zakodowana jako win
...
//define('PL_WIN_SPECIFIC_LOWER', '¹œŸ');  //linijka zakodowana jako win
...
//define('PL_COMMON', 'æê³ñó¿ÆÊ£ÑÓ¯');  //linijka zakodowana jako win lub iso
...
//define('PL_COMMON_UPPER', 'ÆÊ£ÑÓ¯');  //linijka zakodowana jako win lub iso
...
//define('PL_COMMON_LOWER', 'æê³ñó¿');  //linijka zakodowana jako win lub iso
