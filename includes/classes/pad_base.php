...
*/
    function _draw_table_start() {
      ...
      $out.='            <tr>';
      $out.='             <td class="main" colspan="2" align="left"><b>' . TEXT_PRODUCT_OPTIONS . '</b></td>';
      $out.='            </tr>';
      return $out;
    }
        ...
        while ($products_options = tep_db_fetch_array($products_options_query)) {
          ...
          if ($products_options['options_values_price'] != '0') {
		    ...
		    if (DISPLAY_PRICE_BRUTTO_NETTO == 'true') {
				...
				$products_options_array[sizeof($products_options_array)-1]['text'] .= ' (' . $products_options['price_prefix'] . $rto .')';
		 	  } else {
