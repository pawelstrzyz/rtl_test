...
*/
    function _draw_stocked_attributes() {
      ...
      $out.='<tr><td align="right" class=main><b>'.$attributes[0]['oname'].":</b></td><td class=main>".tep_draw_pull_down_menu('id['.$attributes[0]['oid'].']',array_merge(array(array('id'=>0, 'text'=>'Najpierw wybierz '.$attributes[0]['oname'])), $attributes[0]['ovals']),$attributes[0]['default'], "onchange=\"i".$attributes[0]['oid']."(this.form); showPrice(this.form);\"")."</td></tr>\n";

      // Draw second to next to last option dropdowns - no values, with onchange
      for($o=1; $o<sizeof($attributes)-1; $o++) {
        $out.='<tr><td align="right" class=main><b>'.$attributes[$o]['oname'].":</b></td><td class=main>".tep_draw_pull_down_menu('id['.$attributes[$o]['oid'].']',array(array('id'=>0, 'text'=>'Następnie wybierz '.$attributes[$o]['oname'])), '', "onchange=\"i".$attributes[$o]['oid']."(this.form); showPrice(this.form);\"")."</td></tr>\n";
      }        

      // Draw last option dropdown - no values, no onchange      
      $out.='<tr><td align="right" class=main><b>'.$attributes[$o]['oname'].":</b></td><td class=main>".tep_draw_pull_down_menu('id['.$attributes[$o]['oid'].']',array(array('id'=>0, 'text'=>'Następnie wybierz '.$attributes[$o]['oname'])), '', "onchange=\"showPrice(this.form);\"")."</td></tr>\n";
