...
<?php
 ...
 /*  if ($cart->count_contents() > 0) {
	...
	$cart_contents_string .= '<span class="ShoppingCart">' . BOX_HEADING_SHOPPING_CART . '</span><a href="' . tep_href_link('shopping_cart.php'). '" class="null"><span class="null">&nbsp;' . $cart->count_contents() . '</span></a>';


 $info_box_contents =  $cart_contents_string;
