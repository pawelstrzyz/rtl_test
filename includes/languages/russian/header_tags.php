...
define('HEAD_TITLE_TAG_ALL','Имя Магазина');
define('HEAD_DESC_TAG_ALL','Описание');
define('HEAD_KEY_TAG_ALL','Slowa kluczowe');
...
define('HEAD_TITLE_TAG_ALLPRODS','Каталог Продуктов');
...
define('HEAD_DESC_TAG_DEFAULT','Описание');
define('HEAD_KEY_TAG_DEFAULT','Slowa kluczowe');
...
define('HEAD_TITLE_TAG_WHATS_NEW','Нового изделие');
...
define('HEAD_TITLE_TAG_SPECIALS','Promocje');
...
define('HEAD_TITLE_TAG_PRODUCT_REVIEWS_INFO','Просмотрения');
...
define('HEAD_TITLE_TAG_PRODUCT_REVIEWS_WRITE','Напишите Просмотрение');
