...
define('HEAD_TITLE_TAG_ALL','Geschäft Name');
define('HEAD_DESC_TAG_ALL','Beschreibung');
define('HEAD_KEY_TAG_ALL','Schlüsselwörter');
...
define('HEAD_TITLE_TAG_ALLPRODS','Produkt-Katalog');
...
define('HEAD_DESC_TAG_DEFAULT','Beschreibung');
define('HEAD_KEY_TAG_DEFAULT','Schlüsselwörter');
...
define('HEAD_TITLE_TAG_PRODUCT_REVIEWS_INFO','Berichte');
...
define('HEAD_TITLE_TAG_PRODUCT_REVIEWS_WRITE','Schreiben Sie Bericht');
