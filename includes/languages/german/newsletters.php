...
define('EMAIL_WELCOME', '*** Witamy w biuletnie ' . STORE_NAME . ' ***' . "\n\n" . 'Otrzymałeś ten e-mail ponieważ Ty lub ktoś nieupoważniony podał ten adres w formularzu rejestracyjnym biuletynu ' . STORE_NAME . "\n\n" . 'Uwaga: Jeżeli ktoś inny podał ten adres w Twoim imieniu i nie chcesz subskrybować naszego biuletynu możesz kliknąć w link na dole strony, w celu rezygnacji z otrzymywania naszego biuletynu.');
...
define('TEXT_INFORMATION_ERROR', '<b>Wrong data.</b><br><br>Please verify information.');
?>