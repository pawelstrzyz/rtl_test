<?php
/*
  $Id: banner.php 1 2007-12-20 23:52:06Z  $
...
// Display a banner from the specified group or banner id ($identifier)
  function tep_display_banner($action, $identifier) {
    ...
    if (tep_not_null($banner['banners_html_text'])) {
      $banner_string = '<a href="' . tep_href_link(FILENAME_REDIRECT, 'action=banner&goto=' . $banner['banners_id']) . '" target="_blank">' . $banner['banners_html_text'] . '</a>';
    } else {
