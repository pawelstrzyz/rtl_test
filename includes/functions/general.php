<?php
/*
  $Id: general.php 70 2008-02-13 20:29:08Z $
...
////
// Alias function to tep_get_countries, which also returns the countries iso codes    mod eSklep-Os http://www.esklep-os.com
...
// TABLES: tax_rates, zones_to_geo_zones   mod eSklep-Os http://www.esklep-os.com
...
// Text Mode
    ...
    if ( tep_not_null($company) ) {
      $address = $company . $cr . $nip . $cr . $address;
    }
    if ( (ACCOUNT_NIP == 'true') && (tep_not_null($nip)) && ($company == '') ) {
      $address = $nip . $cr . $address;
    }
...
////
// Recursively go through the categories and retreive all parent categories IDs   mod eSklep-Os http://www.esklep-os.com
// TABLES: categories
...
//                    e.g. info@mytepshop.com
  ...
  function tep_mail($to_name, $to_email_address, $email_subject, $email_text, $from_email_name, $from_email_address, $reply_to='') {
    ...
    $message = new email(array($reply_to.'X-Mailer: oscGold Mailer'));
