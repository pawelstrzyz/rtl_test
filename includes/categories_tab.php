<?php
/*
  $Id: categories_tab.php 1 2007-12-20 23:52:06Z $
...
// START CONFIGURATION
  ...
  define (CAT_TABS_HEIGHT,'26'); // Height of the tabs
  define (CAT_TABS_WIDTH_LEFT,'11'); // Width of the left part of the first tab
  define (CAT_TABS_WIDTH_MIDDLE,'23'); // Width of the image between tabs
...
// We are on the home page
	...
	if ($onpage) { //Tab is on
        if ($start) {//1st tab on
		  $categories_string .= '<td class="tabsNavigation" valign="top" height="'.CAT_TABS_HEIGHT.'" width="'.CAT_TABS_WIDTH_LEFT.'" nowrap background="'.DIR_WS_TEMPLATES.'images/misc/curve/left_on.gif">'."\n";
        } else { //middle or last on
    		  $categories_string .= '<td class="tabsNavigation" valign="top" height="'.CAT_TABS_HEIGHT.'" width="'.CAT_TABS_WIDTH_MIDDLE.'" nowrap background="'.DIR_WS_TEMPLATES.'images/misc/curve/middle_on_left.gif">'."\n";
        }
	} else { //Tab is off
        if ($start) { //1st tab off
		  $categories_string .= '<td class="tabsNavigation" valign="top" height="'.CAT_TABS_HEIGHT.'" width="'.CAT_TABS_WIDTH_LEFT.'" nowrap background="'.DIR_WS_TEMPLATES.'images/misc/curve/left_off.gif">'."\n";
        } else {
         	if ($last_on) { //Middle or last tab, previous tab was on
    		  $categories_string .= '<td class="tabsNavigation" valign="top" height="'.CAT_TABS_HEIGHT.'" width="'.CAT_TABS_WIDTH_MIDDLE.'" nowrap background="'.DIR_WS_TEMPLATES.'images/misc/curve/middle_on_right.gif">'."\n";
            } else { //Middle or last tab, previous tab not on
    		  $categories_string .= '<td class="tabsNavigation" valign="top" height="'.CAT_TABS_HEIGHT.'" width="'.CAT_TABS_WIDTH_MIDDLE.'" nowrap background="'.DIR_WS_TEMPLATES.'images/misc/curve/middle_off.gif">'."\n";
            }
        }
	}  	
	...
	if ($onpage) {
		$categories_string .= '<td class="tabsNavigation" valign="middle" height="'.CAT_TABS_HEIGHT.'"  nowrap background="'.DIR_WS_TEMPLATES.'images/misc/curve/menu0_on.gif">'."\n";
	} else {
		$categories_string .= '<td class="tabsNavigation" valign="middle" height="'.CAT_TABS_HEIGHT.'"  nowrap background="'.DIR_WS_TEMPLATES.'images/misc/curve/menu0_off.gif">'."\n";
	}  	
...
// if tab selected we dont need a link
	...
	$categories_string .= '</td>';
      ...
      if ($last_tab) {
	  if ($onpage) {
	    $categories_string .= '<td class="tabsNavigation" valign="top" height="'.CAT_TABS_HEIGHT.'" width="'.CAT_TABS_WIDTH_RIGHT.'" nowrap background="'.DIR_WS_TEMPLATES.'images/misc/curve/right_on.gif">'."\n";
	  } else {
		$categories_string .= '<td class="tabsNavigation" valign="top" height="'.CAT_TABS_HEIGHT.'" width="'.CAT_TABS_WIDTH_RIGHT.'" nowrap background="'.DIR_WS_TEMPLATES.'images/misc/curve/right_off.gif">'."\n";
	    }  	
	}
	$categories_string .= '</td>'."\n";
