...
$mtransfer_mail= "https://www.mbank.com.pl/mtransfer.asp?osCsid=".$osCsid."&ServiceID=".$ServiceID."&Amount=".$Amount."&TrDate=".$TrDate."&Description=".$Description."%20nr%20zamówienia:%20".$insert_id."\nZap³aæ mtransferem, o ile jeszcze tego nie zrobi³eœ</a>";
...
//zwolnienie mtransferu
  ...
  <input type="image" src="<?php echo (bts_select('images','buttons/'.$language.'/button_confirm_order.gif')); ?>" alt="Potwierdz zamówienie" title=" Potwierdz zamówienie "; ?>
  </form>
  </center>
  </body>
  </html>
