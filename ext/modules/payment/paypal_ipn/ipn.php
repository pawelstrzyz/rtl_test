<?php
/*
  $Id: ipn.php 1 2007-12-20 23:52:06Z $
...
// $order variables have been changed from checkout_process to work with the variables from the function query () instead of cart () in the order class
  ...
  tep_mail($order->customer['name'], $order->customer['email_address'], $temat, $email_order, STORE_OWNER, STORE_OWNER_EMAIL_ADDRESS);


// send emails to other people
  if (SEND_EXTRA_ORDER_EMAILS_TO != '') {
    tep_mail('', SEND_EXTRA_ORDER_EMAILS_TO, $temat, $email_order, STORE_OWNER, STORE_OWNER_EMAIL_ADDRESS);
  }
