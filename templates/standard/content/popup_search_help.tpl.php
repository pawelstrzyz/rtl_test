<table border="0" width="100%" cellspacing="0" cellpadding="0">
 ...
 <!-- Naglowek BOF -->
	<tr>  
      ...
      <td height="35" class="infoBoxHeading" width="100%"><?php echo HEADING_SEARCH_HELP; ?></td>
 ...
 <tr>
  <td align="right" class="main"><a href="javascript:window.close()"><?php echo TEXT_CLOSE_WINDOW; ?></a></td>
 </tr>
</table>