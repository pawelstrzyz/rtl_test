...
?>
 ...
 <tr>
  <td class="subTileModule"><?php echo '<b>' . TABLE_HEADING_DOKUMENT_SPRZEDAZY . '</b>';?></td>
 </tr>
     ...
     <td>
	  <table border="0" width="100%" cellspacing="0" cellpadding="2">
       <tr>
        <td class="main">
		<?php 
		if ($HTTP_POST_VARS['paragon'] == "paragon") {
			echo TEXT_PARAGON;
			$rty = '(' . TABLE_HEADING_DOKUMENT_SPRZEDAZY . ': ' . TEXT_PARAGON . ')    ';
			} else {
			echo TEXT_FAKTURA;
			$rty = '(' . TABLE_HEADING_DOKUMENT_SPRZEDAZY . ': ' . TEXT_FAKTURA . ')    ';
		}		
		?>
		</td>
       </tr>
	  ...
	  <table border="0" width="100%" cellspacing="0" cellpadding="2">
       <tr>
        ...
        <td align="right" class="main">
		 ...
		 echo '<input type="hidden" name="dok_zakup" value="' . $rty . '">';
