<?php
/*
  $Id: \templates\standard\content\checkout_payment_address.tpl.php; 09.07.2006
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
 ...
 <tr>
  <td>
   <table border="0" width="100%" cellspacing="0" cellpadding="0">
    <tr>
     <td class="subTileModule"><b><?php echo TABLE_HEADING_PAYMENT_ADDRESS; ?></b></td>
    </tr>
   </table>
  </td>
 </tr>
       ...
       <tr>
        ...
        <td align="right" width="50%" valign="top">
		 <table border="0" cellspacing="0" cellpadding="2">
          <tr>
           <td class="main" align="center" valign="top"><?php echo '<b>' . TITLE_PAYMENT_ADDRESS . '</b><br>' . tep_image(DIR_WS_TEMPLATES . 'images/misc/arrow_south_east.gif'); ?></td>
           <td><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
 ...
 <tr>
  <td>
   <table border="0" width="100%" cellspacing="0" cellpadding="0">
    <tr>
     <td class="subTileModule"><b><?php echo TABLE_HEADING_ADDRESS_BOOK_ENTRIES; ?></b></td>
    </tr>
   </table>
  </td>
 </tr>
     ...
     <td>
	  <table border="0" width="100%" cellspacing="0" cellpadding="2">
       <tr>
        ...
        <td class="main" width="50%" valign="top" align="right"><?php echo '<b>' . TITLE_PLEASE_SELECT . '</b><br>' . tep_image(DIR_WS_TEMPLATES . 'images/misc/arrow_east_south.gif'); ?></td>
        <td><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
       </tr>
       <?php
       $radio_buttons = 0;
 ...
 <tr>
  <td>
   <table border="0" width="100%" cellspacing="0" cellpadding="0">
    <tr>
     <td class="subTileModule"><b><?php echo TABLE_HEADING_NEW_PAYMENT_ADDRESS; ?></b></td>
    </tr>
   </table>
  </td>
 </tr>
