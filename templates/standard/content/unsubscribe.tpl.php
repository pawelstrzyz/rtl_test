<?php
/*
  $Id: \templates\standard\content\unsubscribe.tpl.php; 09.07.2006
     ...
     <td>
	  <table border="0" width="100%" cellspacing="0" cellpadding="2">
       <tr>
        ...
        <td align="right"><?php echo '<a href="' . tep_href_link($filename_unsubscribe_done, '', 'NONSSL') . '">' . tep_image_button('button_unsubscribe.gif', IMAGE_BUTTON_CONTINUE) . '</a>'; ?></td>
        <td width="10"><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
       </tr>
      </table>
	 </td>
