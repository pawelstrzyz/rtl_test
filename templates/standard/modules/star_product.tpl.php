                 ...
                 <tr>
                  <td height="25" class="star-product-title">' . $star_products['products_name'] . '</td>
                   <td  align="center" valign="middle" height="100%" rowspan="4">' .
                    (isset($star_products['products_image']) ? '<div style="width: '.$szerokosc.'px; height: '.$wysokosc.'px; padding: 0px 0px;"><table border="0" cellpadding="0" cellspacing="0" width="'.$szerokosc.'"><tr><td class="t1"></td><td class="t2"></td><td class="t3"></td></tr><tr><td class="t4"></td><td class="t5" align="center" valign="middle" height="'.$wysokosc.'">' . tep_image(DIR_WS_IMAGES . $star_products['products_image'], $star_products['products_name'], SMALL_IMAGE_WIDTH*1.2, SMALL_IMAGE_HEIGHT*1.2) . '
                    </td><td class="t6"></td></tr><tr><td class="t7"></td><td class="t8"></td><td class="t9"></td></tr></table></div>' : '').'</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                   <td height="35" class="star-product-price" align="center">'.$star_price . '
                  </td>
                 </tr>
               <tr>
                <td align="center">
