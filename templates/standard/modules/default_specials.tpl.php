...
while ($default_specials = tep_db_fetch_array($default_specials_query)) {
    ...
    echo '
    <td width="'.$szer_tab.'%" align="right" valign="top">
       ...
       <table width="100%" border="0" cellspacing="0" cellpadding="2">
        <tr>
         <td align="center" valign="top" height="35">
          <a class="ProductTile" href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $default_specials['products_id']) . '">' . $default_specials['products_name'] . '</a>
         </td>
        </tr>
        <tr>
         <td align="center" valign="middle">
          <table border="0" cellspacing="0" cellpadding="0">
	       ...
	       (isset($default_specials['products_image']) ? '
           ...
           <table border="0" cellpadding="0" cellspacing="0"><tr>
            ...
            <td class="t5" align="center" valign="middle" height="'.SMALL_IMAGE_HEIGHT.'px" width="'.SMALL_IMAGE_WIDTH.'px">
             <a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $default_specials['products_id']) . '">' . tep_image(DIR_WS_IMAGES . $default_specials['products_image'], $default_specials['products_name'], SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT) . '</a>
            </td><td class="t6"></td>
            </tr><tr>
            <td class="t7"></td>
            <td class="t8"></td>
        ...
        <tr>
         <td align="center">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
           <tr>
            <td align="center" width="50%" height="28" class="Button"><a class="ProductDescripion" href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $default_specials["products_id"]) . '">'.tep_image_button('small_view.gif').'</a></td>
