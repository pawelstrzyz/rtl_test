<?php
/*
  $Id: \templates\standard\content\checkout_shipping_address.tpl.php; 09.07.2006
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
       ...
       <tr>
        ...
        <td align="right" width="50%" valign="top">
		 <table border="0" cellspacing="0" cellpadding="2">
          <tr>
           <td class="main" align="center" valign="top"><?php echo '<b>' . TITLE_SHIPPING_ADDRESS . '</b><br>' . tep_image(DIR_WS_TEMPLATES . 'images/misc/arrow_south_east.gif'); ?></td>
           <td><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
 ...
 <tr>
  <td>
   <table border="0" width="100%" cellspacing="0" cellpadding="0">
    <tr>
     <td class="subTileModule"><b><?php echo TABLE_HEADING_NEW_SHIPPING_ADDRESS; ?></b></td>
    </tr>
   </table>
  </td>
 </tr>
