...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
 ...
 ?>
<tr>
<td class="main"><img src="templates/grafika_07/images/categoriesbox/category_bullet.gif" class="s" alt=""> <?php echo BOX_ADVSEARCH_KW; ?></td>
<td class="main"><?php echo tep_draw_input_field('keywords', '', 'style="width: 100%"'); ?></td>
</tr>
<tr>
<td class="main"><img src="templates/grafika_07/images/categoriesbox/category_bullet.gif" class="s" alt=""> <?php echo TEXT_SEARCH_IN_DESCRIPTION; ?></td>
...
<tr>
<td class="main"><img src="templates/grafika_07/images/categoriesbox/category_bullet.gif" class="s" alt=""> <?php echo ENTRY_CATEGORIES; ?></td>
...
<tr>
<td class="main"><img src="templates/grafika_07/images/categoriesbox/category_bullet.gif" class="s" alt=""> <?php echo ENTRY_INCLUDE_SUBCATEGORIES; ?></td>
...
<tr>
<td class="main"><img src="templates/grafika_07/images/categoriesbox/category_bullet.gif" class="s" alt=""> <?php echo ENTRY_MANUFACTURERS; ?></td>
...
<tr>
<td class="main"><img src="templates/grafika_07/images/categoriesbox/category_bullet.gif" class="s" alt=""> <?php echo ENTRY_PRICE_FROM; ?></td>
<td class="main"><?php echo tep_draw_input_field('pfrom'); ?></td>
</tr>
<tr>
<td class="main"><img src="templates/grafika_07/images/categoriesbox/category_bullet.gif" class="s" alt=""> <?php echo ENTRY_PRICE_TO; ?></td>
...
<tr>
<td class="main"><img src="templates/grafika_07/images/categoriesbox/category_bullet.gif" class="s" alt=""> <?php echo ENTRY_DATE_FROM; ?></td>
<td class="main"><?php echo tep_draw_input_field('dfrom', DOB_FORMAT_STRING, 'onFocus="RemoveFormatString(this, \'' . DOB_FORMAT_STRING . '\')"'); ?></td>
</tr>
<tr>
<td class="main"><img src="templates/grafika_07/images/categoriesbox/category_bullet.gif" class="s" alt=""> <?php echo ENTRY_DATE_TO; ?></td>
