<?php
/*
  $Id: \templates\standard\content\info_pages.tpl.php; 09.07.2006
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
 ...
 <!-- Naglowek BOF -->
	<tr>  
      ...
      <td height="35" class="infoBoxHeading" width="100%"><?php echo sprintf( $page_check[ pages_title ]); ?></td>
     ...
     <td>
	  <table border="0" width="100%" cellspacing="0" cellpadding="2">
       <tr>
        ...
        <td align="right"><a href="index.php"><?php echo tep_image_button('button_back.gif', IMAGE_BUTTON_BACK); ?></a></td>
        <td width="10"><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
       </tr>
      </table>
	 </td>
