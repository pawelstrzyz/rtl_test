    ...
    echo '
                             <td width=255 valign=top>
                                  <table border=0  cellspacing=0 cellpadding=0 width=230 align=center>
                                   <tr><td width=140 valign=top><br><b><a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $new_products['products_id']) . '">' . $new_products['products_name'] . '</a></b><br><br><br><span class=ps3>'.$cena_produktu .'</span><br><br></td>
                                   <td><a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $new_products['products_id']) . '">' . tep_image(DIR_WS_IMAGES . $new_products['products_image'], $new_products['products_name'], SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT) . '</a></td></tr>
                                   
								   <tr><td colspan=2 height=6></td></tr>
                                   <tr><td colspan=2><a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $new_products["products_id"]) . '">'.tep_image_button('small_view.gif').'</a>&nbsp;' .$przcisk_kup.'</td></tr>
                                   <tr><td colspan=2 height=6></td></tr>
                                  </table>
                                 </td>
        ';
